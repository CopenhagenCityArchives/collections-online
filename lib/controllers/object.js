...
exports.index = function(req, res, next) {
  ...
  .then(function(objectMetadata) {
    ...
    objectMetadata.assets = objectMetadata.related_assets.filter(function(asset) {
...
exports.interestingCoins = function(req, res, next) {
  natmusApi.request('Search', 'GET', {
    ...
    var links = result.results.map(function(object) {
      var href = '/objects/'+ object.collection +'/'+ object.id;
      return '<a href="' +href+ '">' +object.collection+'/'+object.id+ '</a>';
    }).map(function(link) {
      return '<li>' + link + '</li>';
    });
